    ...
    <c:param name="content">
        ...
        <form method="POST" action="<c:url value='?action=${action}&command=${commCrt}' />">
            ...
            <input class="form-control" type="text"
                name="${AttributeConst.USE_NAME.getValue()}" value="${user.name}" />
            <br />
            <br /> <label for="${AttributeConst.USE_EMAIL.getValue()}">メールアドレス</label><br />
            <input class="form-control" type="text"
                name="${AttributeConst.USE_EMAIL.getValue()}" value="${user.email}" />
            <br />
            <br /> <label for="${AttributeConst.USE_PASS.getValue()}">パスワード</label><br />
            <input class="form-control" type="password"
                name="${AttributeConst.USE_PASS.getValue()}" /> <br />
            <br /> <label for="password_confirmation">パスワードの確認</label><br /> <input
                class="form-control" name="password_confirmation" type="password"
                value="" id="password_confirmation"> <br />
